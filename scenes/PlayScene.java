...
public class PlayScene extends Scene {
    ...
    public void sceneBegin() {
        ...
        // 背景
        img = SceneController.instance().irc().tryGetImage(new Path().image().backgrounds().backgroundLobby());
...
//                                UNIT_Y * tmp.getY() + UNIT_Y * tmp.getSizeY() / 4,
//                                UNIT_X * 2, UNIT_Y * 2,
//                                MonsterAnimator.MonsterType.WATERLINE, new Vector(0, 1), new Delay(100)));
//                        break;
