...
public class PlayHellScene extends Scene {
    ...
    private static double passedTime; // update 持續時不斷更新
    ...
    public PlayHellScene(ArrayList<Player> inputPlayers) {
    ...
    public void sceneBegin() {
        // 音樂播放
        AudioResourceController.getInstance().loop(new Path().sound().bgm().bgmPlayHell(), 99);
        ...
        // 背景
        img = SceneController.instance().irc().tryGetImage(new Path().image().backgrounds().backgroundHell());
    ...
    public void sceneEnd() {
        ...
        AudioResourceController.getInstance().stop(new Path().sound().bgm().bgmPlayHell());
    }
    ...
    public void paint(Graphics g) {
        ...
        int backgroundHeight = 1318; // 1280
    ...
    private void mapInitialize() {
        try {
            ArrayList<MapInfo> mapInfo = new MapLoader("genMapHell.bmp", "genMapHell.txt").combineInfo();
                ...
                switch (tmp.getName()) {
                    ...
                    case "brickMoveLR":
                        bricks.add(new Brick(UNIT_X * tmp.getX() + UNIT_X * tmp.getSizeX() / 2,
                                ...
                                UNIT_X,
                                BrickAnimator.BrickType.BRICK_HELL_MOVE_LR, new Vector(3, 0), new Delay(150)));
                        break;
                    // 會動 brick 上下動
                    case "brickMoveUD":
                        bricks.add(new Brick(UNIT_X * tmp.getX() + UNIT_X * tmp.getSizeX() / 2,
                                UNIT_Y * tmp.getY() + UNIT_Y * tmp.getSizeY() / 2,
                                UNIT_X,
                                BrickAnimator.BrickType.BRICK_HELL_MOVE_UD, new Vector(0, 2), new Delay(200)));
                        break;
                    // 會動 brick 斜動
                    case "brickMoveSlash":
                        bricks.add(new Brick(UNIT_X * tmp.getX() + UNIT_X * tmp.getSizeX() / 2,
                                UNIT_Y * tmp.getY() + UNIT_Y * tmp.getSizeY() / 2,
                                UNIT_X,
                                BrickAnimator.BrickType.BRICK_HELL_MOVE_SLASH, new Vector(2, 2), new Delay(200)));
                        break;
                    // 踩過會消失
                    case "brickVanish":
                        bricks.add(new Brick(UNIT_X * tmp.getX() + UNIT_X * tmp.getSizeX() / 2,
                                UNIT_Y * tmp.getY() + UNIT_Y * tmp.getSizeY() / 2,
                                BrickAnimator.BrickType.BRICK_HELL_VANISH, new Delay(15)));
                        break;
                    // 固定的磚塊
                    case "brickFix":
                        bricks.add(new Brick(UNIT_X * tmp.getX() + UNIT_X * tmp.getSizeX() / 2,
                                UNIT_Y * tmp.getY() + UNIT_Y * tmp.getSizeY() / 2,
                                UNIT_X, UNIT_Y,
                                BrickAnimator.BrickType.BRICK_HELL_FIX));
                        break;
                    // 水柱
                    case "brickSpring":
                        bricks.add(new Brick(UNIT_X * tmp.getX() + UNIT_X * tmp.getSizeX() / 2,
                    ...
                    case "monsterMoveLong":
                        monsters.add(new Monster(UNIT_X * tmp.getX() + UNIT_X * tmp.getSizeX() / 2,
                                UNIT_Y * tmp.getY() + UNIT_Y * tmp.getSizeY() / 4,
                                UNIT_X * 2, UNIT_Y * 2,
                                MonsterAnimator.MonsterType.SKELETON_LR, new Vector(-2, 0), new Delay(300)));
                        break;
                    ...
                    case "monsterFlyLR":
                        monsters.add(new Monster(UNIT_X * tmp.getX() + UNIT_X * tmp.getSizeX() / 2,
                                UNIT_Y * tmp.getY() + UNIT_Y * tmp.getSizeY() / 4,
                                UNIT_X * 2, UNIT_Y * 2,
                                MonsterAnimator.MonsterType.GHOST_LR, new Vector(-3, 0), new Delay(300)));
                        break;
                    // 在空中左右移動 ( 7 個單位), 怪物的種類圖片顯示請自行調整
                    case "monsterFlyLRShort":
                        monsters.add(new Monster(UNIT_X * tmp.getX() + UNIT_X * tmp.getSizeX() / 2,
                                UNIT_Y * tmp.getY() + UNIT_Y * tmp.getSizeY() / 4,
                                UNIT_X * 2, UNIT_Y * 2,
                                MonsterAnimator.MonsterType.BAT_LR, new Vector(-2, 0), new Delay(100)));
                        break;
                    ...
                    case "monsterFlyUD":
                        monsters.add(new Monster(UNIT_X * tmp.getX() + UNIT_X * tmp.getSizeX() / 2,
                                UNIT_Y * tmp.getY() + UNIT_Y * tmp.getSizeY() / 4,
                                UNIT_X * 2, UNIT_Y * 2,
                                MonsterAnimator.MonsterType.GHOST_UD, new Vector(0, 3), new Delay(100)));
                        break;
                    ...
                    case "monsterFlyLRShoot":
                        monsters.add(new Monster(UNIT_X * tmp.getX() + UNIT_X * tmp.getSizeX() / 2,
                                ...
                                MonsterAnimator.MonsterType.DEMON_LR, new Vector(2, 0), new Delay(120)));
                        break;
                    // 會向上的尖刺
                    case "monsterSpikes":
                        monsters.add(new Monster(UNIT_X * tmp.getX() + UNIT_X * tmp.getSizeX() / 2,
        ...
        for (int i = 0; i < bricks.size(); i++) {
            ...
            if (tmp.isCollision(brick)) {
                ...
                if (tmp.collider().bottom() > brick.collider().top()
                    ...
                    // 如果是會移動磚塊
                    if (brick.getBrickType() == BrickAnimator.BrickType.BRICK_HELL_MOVE_LR
                            || brick.getBrickType() == BrickAnimator.BrickType.BRICK_HELL_MOVE_UD
                            || brick.getBrickType() == BrickAnimator.BrickType.BRICK_HELL_MOVE_SLASH) {
                        // 站在會動的平台上速度會跟平台一樣
                    ...
                    if (brick.getBrickType() == BrickAnimator.BrickType.BRICK_HELL_VANISH) {
                        // 還沒被踩過為 false
                        if (!brick.getVanish()) {
...
//                AudioResourceController.getInstance().play(new Path().sound().FOOD());
                //設定重生點
